...
namespace AMLCore.Injection.Engine.Script
{
    public static class SquirrelFunctions
    {
        ...
        internal static readonly uint Addr_sq_rget = 0x12DED9;
        internal static readonly uint Addr_sq_rset = 0x12DD79;

        public static Delegate_PI_I set = GetFunction<Delegate_PI_I>(Addr_sq_set);
